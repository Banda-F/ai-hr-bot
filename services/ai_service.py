...
from utils.config import GIGACHAT_BASE64, GIGACHAT_MODEL

logger = logging.getLogger(__name__)

class GigaChatAsync:
    def __init__(self, base64_creds: str = GIGACHAT_BASE64, model: str = GIGACHAT_MODEL):
        self.base64_creds = base64_creds
        self.model = model
